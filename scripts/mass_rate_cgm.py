# calculates the rate of mass flux of the cgm 
# plots radial profile of flux
...
out_fn = '/scratch/08263/tg875625/CGM/plots/cgm_mass_rate_profile_symlog.pdf'
...
for i in range(len(ts_nums)):
    ...
    # remove disk particles 
    p = h1[i].g[~disk]

    p_profile.append(profile.Profile(p.g, rmax='280 kpc', ndim=3))
